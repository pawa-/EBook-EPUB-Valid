...
{
    my ($is_valid, $out) = is_valid_epub('epub/valid.epub');
...
{
    my ($is_valid, $out)
        = is_valid_epub('share/epubcheck-3.0.1/epubcheck-3.0.1.jar', 'epub/valid.epub');
...
{
    my ($is_valid, $out) = is_valid_epub('epub/invalid.epub');
...
{
    my ($is_valid, $out)
        = is_valid_epub('share/epubcheck-3.0.1/epubcheck-3.0.1.jar', 'epub/invalid.epub');
...
{
    my ($is_valid, $out) = is_valid_epub('epub/valid.epubbb');
...
{
    my ($is_valid, $out)
        = is_valid_epub('share/epubcheck-3.0.1/epubcheck-3.0.1.jar', 'epub/valid.epubbb');
...
{
    my ($is_valid, $out)
        = is_valid_epub('share/epubcheck-3.0.1/epubcheck-3.0.1.jarrr', 'epub/valid.epub');
